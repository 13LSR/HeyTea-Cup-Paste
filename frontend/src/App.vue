<template>
  <div class="min-h-screen bg-white/70 pb-16 text-gray-900">
    <div class="mx-auto max-w-6xl px-4 py-10">
      <header class="flex flex-col gap-6 pb-8">
        <div class="flex flex-wrap items-center justify-between gap-3">
          <p class="text-sm font-semibold uppercase tracking-wide text-gray-700">HeyTea-Cup-Paste</p>
          <a
            :href="GITHUB_URL"
        ...
        <h1 class="text-3xl font-bold text-gray-900">喜茶DIY杯贴</h1>
          ...
          <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm space-y-6">
            ...
            <div class="grid gap-6 lg:grid-cols-2">
              ...
              <div class="space-y-4">
                ...
                <div v-if="!uploadState" class="rounded-lg border border-gray-200 bg-white p-5">
                  <div class="flex items-start gap-3">
                    <el-icon :size="20" class="text-green-600 mt-0.5">
                      <Pointer />
                    </el-icon>
                    <div class="flex-1">
    ...
    <section class="mt-10 px-4">
      <div class="mx-auto max-w-5xl rounded-2xl bg-white/95 p-6 text-gray-900 shadow-xl border border-white/70">
        ...
        <ol class="space-y-4 text-sm leading-relaxed">
          ...
          <li>
            <p class="font-semibold">2. 上传失败，提示 “文件格式不允许上传”。</p>
            <p class="text-gray-600">
              请确保上传的原始文件为 PNG；JPG 会自动转换成 PNG，但不排除失败可能，可更换 PNG 文件后重试。
            </p>
          </li>
          <li>
            <p class="font-semibold">3. 上传成功后小程序不显示</p>
            <p class="text-gray-600">
              确认上传工具使用的账号和喜茶登录账号保持一致，随后刷新喜茶小程序。
            </p>
          </li>
          <li>
            <p class="font-semibold">4. 其他上传失败</p>
            <p class="text-gray-600">
...
const DONATE_QR_URL = 'https://dataphoto.sibnet.ru/upload/imggreat/1763393134741481101.jpg';
